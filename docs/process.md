...
3. **GREEN** получает TaskSpec и красные тесты. Пишет минимальный код, пока тесты не позеленеют. Менять тесты он не может физически. Лимит — 3 итерации, дальше эскалация.
